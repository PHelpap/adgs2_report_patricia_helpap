...
phenology_stats |>
 ggplot(aes(x = DOY_modis, y = DOY_pred)) +
  ...
  annotate("text", x = 98.7, y = 139,
           label = paste("Y =", phen_slope, "X +", phen_intercept), color = "skyblue3", size = 5) +
  annotate("text", x = 99, y = 142,
           label = paste("Correlation R = ", cor_phen), color = "black", size = 5) +
  annotate("text", x = 99, y = 136,
           label = paste("MW p-value = ", P_phen), color = "red3", size = 5) +
  #  xlim(0,150)+
  ylim(100,145)+
    theme_classic()
...
- The resulting slope and intercept of the linear model show that the predicted values are overall higher than the observed MODIS data for this region. 
